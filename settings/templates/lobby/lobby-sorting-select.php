...
<select name="<?=$id?>" id="<?=$id?>">
    ...
    <option value="modifiednewest"<?php if ($orderGamesBy=="modifiednewest") echo ' selected="true"';  ?>>Last Modified Date (Newest first)</option>
    <option value="modifiedoldest"<?php if ($orderGamesBy=="modifiedoldest") echo ' selected="true"';  ?>>Last Modified Date (Oldest first)</option>
