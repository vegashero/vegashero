...
<li>
  <ul>
    ...
    <li>*In order to display the games grid correctly we recomend the use of a full-width page template. If your theme doesn't support a full-width page template or you insist on showing a sidebar next to the lobby we suggest that a minimum of 800px wide content area is recommended where the lobby shortcode is added.</li>
  </ul>
  <div class="clear"></div>
</li>
