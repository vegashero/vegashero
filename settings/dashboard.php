...
class Vegashero_Settings_Dashboard
{
    ...
    public function registerSettings() {
        ...
        'vegashero_lobbySettings_section', 
        __( 'Lobby Settings', 'vhero' ), 
        '', 
        'lobbySettings'
        );
        add_settings_field( 
        'vegashero_lobbyGamesPerPage', 
        __( 'Number of games to show', 'vhero' ), 
        array($this, 'vegashero_lobbyGamesPerPage_render'), 
        'lobbySettings', 
        'vegashero_lobbySettings_section' 
        );
    ...
    public function vegashero_lobbyGamesPerPage_render() { 
        ...
        echo "<input type='text' name='vegashero_settings[vegashero_lobbyGamesPerPage]' placeholder='20' value='".$gamecountnew."'>";
