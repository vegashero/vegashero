...
class Lobby extends Settings {
	...
	public function sectionHeading() {
		...
		$id    = $args[0]['id'];
		$title = $args[0]['title'];
		include_once __DIR__ . '/templates/lobby/section-heading.php';
	}

	public function inputForGamesPerPage() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/lobby/games-per-page-input.php';
	}

	public function selectLobbySorting() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/lobby/lobby-sorting-select.php';
	}
	...
	public function inputLobbyFiltersOp() {
		...
		?><input name="<?php echo $id_op; ?>" id="<?php echo $id_op; ?>" type='text' value='<?php echo get_option( $id_op ) ? get_option( $id_op ) : $default; ?>' />
		<?php
	}
	public function inputLobbyFiltersCat() {
		...
		?>
		<input name="<?php echo $id_cat; ?>" id="<?php echo $id_cat; ?>" type='text' value='<?php echo get_option( $id_cat ) ? get_option( $id_cat ) : $default; ?>' />
		<?php
	}
	public function inputLobbyFiltersProv() {
		...
		?>
		<input name="<?php echo $id_prov; ?>" id="<?php echo $id_prov; ?>" type='text' value='<?php echo get_option( $id_prov ) ? get_option( $id_prov ) : $default; ?>' />
		<?php
	}
	...
	public function inputPlayNowBtn() {
		...
		?>
		<input name="<?php echo $id; ?>" id="<?php echo $id; ?>" type='text' value='<?php echo get_option( $id ) ? get_option( $id ) : $default; ?>' />
		<?php
	}
	...
	public function tickboxLobbySearch() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/lobby/lobby-search-tickbox.php';
	}

	public function tickboxLobbyLink() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/lobby/lobby-link-tickbox.php';
	}

	public function tickboxLobbyWebp() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/lobby/lobby-webp-tickbox.php';
	}
	public function tickboxPlayDemoBtn() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/lobby/game-playdemobtn-tickbox.php';
	}
	public function tickboxGameWidgetTop() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/lobby/game-GameWidgetTop-tickbox.php';
	}
	...
	public function createLobbyPage() {
		include_once __DIR__ . '/templates/lobby.php';
	}
