...
class Permalinks extends Settings {
	...
	public function addSettingsMenu() {
		add_submenu_page(
			...
			// The title to be displayed on this menu's corresponding page
			$page_title = wp_strip_all_tags( __( 'Permalinks', 'vegashero' ) ),
			// The text to be displayed for this actual menu item
			$menu_title = wp_strip_all_tags( __( 'Permalinks', 'vegashero' ) ),
			// The text to be displayed for this actual menu item
			$capability = 'manage_options',
			// Which type of users can see this menu
			$menu_slug = self::MENU_SLUG,
			// The unique ID - that is, the slug - for this menu item
			$callback = array( $this, 'createPermalinksPage' )
	...
	public function createPermalinksPage() {
		include_once __DIR__ . '/templates/permalinks.php';
	}
	...
	public function sectionHeading() {
		...
		$id    = $args[0]['id'];
		$title = $args[0]['title'];
		include_once __DIR__ . '/templates/permalinks/section-heading.php';
	}
	...
	public function inputForCustomPostTypeUrl() {
		...
		include_once __DIR__ . '/templates/permalinks/custom-post-type-url-input.php';
	}

	public function disableGamesArchive() {
		$args = func_get_args();
		$id   = $args[0]['id'];
		include_once __DIR__ . '/templates/permalinks/disable-gamesarchive-tickbox.php';
	}
	...
	public function inputForGameCategoryUrl() {
		...
		include_once __DIR__ . '/templates/permalinks/game-category-url-input.php';
	}
	...
	public function inputForGameOperatorUrl() {
		...
		include_once __DIR__ . '/templates/permalinks/game-operator-url-input.php';
	}
	...
	public function inputForGameProviderUrl() {
		...
		include_once __DIR__ . '/templates/permalinks/game-provider-url-input.php';
	}
	...
	public function registerSettings() {
		...
		register_setting(
			...
			// must match page slug name from add_settings_field
