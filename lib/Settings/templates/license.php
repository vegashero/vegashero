<div class="wrap vh-about-wrap">
    ...
    <div class="helpinfo">
        ...
        <p>
            <?= wp_kses(sprintf(__('We also offer stylish and functional WP themes that integrate well with our games plugin. Choose from a <a target="_blank" href="%1$s">Casino Theme</a> or a <a target="_blank" href="%2$s">Sportsbook Theme</a>.', 'vegashero'), esc_url('https://vegashero.co/downloads/vegashero-theme/?utm_source=VegasHeroPlugin&utm_medium=admin&utm_campaign=license%20settings%20page'), esc_url('https://vegashero.co/downloads/sports-betting-theme/?utm_source=VegasHeroPlugin&utm_medium=admin&utm_campaign=license%20settings%20page')), ["a" => ["target" => true, "href" => true]]) ?>
            <br/>
            <?= wp_kses(sprintf(__('You can also get the <a target="_blank" href="%1$s">plugin + theme in a bundle license</a> and save money.', 'vegashero'), esc_url('https://vegashero.co/checkout?edd_action=add_to_cart&download_id=132994&edd_options[price_id]=1')), ["a" => ["target" => true, "href" => true]]) ?>
        </p>
    </div>
    ...
    <div class="helpinfo">
        ...
        <p>
            <?= wp_kses(sprintf(__('Check us out on <a target="_blank" href="%1$s">Facebook</a> and follow our <a target="_blank" href="%2$s">Twitter</a> feed. We post about latest version updates, industry news and events and game release info.', 'vegashero'), esc_url('https://www.facebook.com/VegasHeroPlugin/'), esc_url('https://twitter.com/Vegas_Hero">Twitter')), ["a" => ["href" => true, "target" => true]]) ?>
            <br/>
        ...
        <p>
            <?= wp_kses(sprintf(__('Email us: <a href="%1$s">%2$s</a>', 'vegashero'), antispambot('mailto:support@vegashero.co'), antispambot('support@vegashero.co')), ["a" => ["href" => true]]) ?>
        </p>

        <p>
            <?= wp_kses(sprintf(__('See the <a target="_blank" href="%1$s">FAQs</a>.', 'vegashero'), esc_url('https://vegashero.co/faq/?utm_source=VegasHeroPlugin&utm_medium=admin&utm_campaign=license%20settings%20page')), ["a" => ["target" => true, "href" => true]]) ?>
        </p>

        <p>
            <?= wp_kses(sprintf(__('Browse the <a target="_blank" href="%1$s">support section</a> of our website.', 'vegashero'), esc_url('https://vegashero.co/category/support/?utm_source=VegasHeroPlugin&utm_medium=admin&utm_campaign=license%20settings%20page')), ["a" => ["target" => true, "href" => true]]) ?> 
        </p>
