...
<ul class="instructions">
    <li>
      <ul>
          ...
          <li><?= wp_kses(sprintf(__('<b>2.</b> Add in this shortcode %1$s[vegashero-lobby]%2$s', 'vegashero'), '<span style="background:#f3f3f3; padding:3px 8px;">', '</span>'), ["b" => [], "span" => ["style" => true]]) ?></li>
