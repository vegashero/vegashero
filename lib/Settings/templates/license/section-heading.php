...
<div class="updated" style="display:block!important;">
    ...
    <p class="description">
        <?= wp_kses(sprintf(__('The free version of the plugin will let you import 2 games per software provider. To get full access to the game database: <strong><a target="_blank" href="%1$s">purchase a license key here.</a></strong>', 'vegashero'), esc_url('https://vegashero.co/downloads/vegas-hero-plugin/?utm_source=VegasHeroPlugin&utm_medium=admin&utm_campaign=license%20settings%20page')), ["strong" => [], "a" => ["target" => true, "href" => true]]) ?>
    </p>
</div>
<?php endif ?>

<p class="description">
    <?= wp_strip_all_tags(__("Enter your license code to activate full import features and game updates.", "vegashero"))?>
    <br>
