	  <div class="wrap vh-about-wrap">
		...
		<p class="description">
			<?php echo wp_kses( __( 'Imported games will be grouped by casino <u>operator</u> and game <u>category</u>.', 'vegashero' ), array( 'u' => array() ) ); ?>
			<br>
			<?php
			echo wp_kses(
		...
		<?php if ( isset( $this->_operators ) && count( $this->_operators ) ) : ?>
			...
			<?php foreach ( $this->_operators as $operator ) : ?>
				  <li class="<?php echo esc_attr( sprintf( 'op-%s', $operator['operator'] ) ); ?>">
					  ...
					  <span class="op-ribbon-content"><?php echo wp_strip_all_tags( __( 'Featured', 'vegashero' ) ); ?></span>
					  </span>
					  <div class="desc">
						  <h2 class="operatorname"><?php echo $operator['operator']; ?></h2>
