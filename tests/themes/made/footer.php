...
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 948107251;
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/948107251/?value=0&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
<script>
  window.addEventListener('load',function(){
    jQuery('a:contains("Play Now")').click(function(){
      var label=jQuery(this).parents('tr').find('img').attr('alt');
      __gaTracker('send', 'event', 'Play Now', 'click', label);
    });
  });
</script>
