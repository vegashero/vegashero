    ...
    public function wrapSingleCustomPostContent($content) {
        ...
        if ( get_post_type( $post_id ) == $this->_config->customPostType ) {
            ...
            foreach($operators as $operator) {
                ...
                $tablebody_template .= sprintf($tablebody_string, $this->_config->gameImageUrl, $operator->slug, $operator->name, $affiliate_url);
            }
            ...
            $content = sprintf("%s %s %s", $iframe_template, $content, $shortcodetable_widget);
        }
        return $content;
    }
